                ...
                >
                  ...
                  <div className="hidden md:flex md:flex-col md:items-center relative group w-full md:w-auto">
                    ...
                    <div
                      ...
                      ${index === 0 ? 'left-0' : index === boliviaHistory.periods.length - 1 ? 'right-0' : 'left-1/2 transform -translate-x-1/2'}
                    ...
                    >
                      ...
                      <div className={`absolute ${index % 2 === 0 ? 'top-full' : 'bottom-full'} 
                        ${index === 0 ? 'left-8' : index === boliviaHistory.periods.length - 1 ? 'right-8' : 'left-1/2 transform -translate-x-1/2'} 
                        w-0 h-0`}
                        style={{
