export const alianzaunidad = {
  id: 'alianzaunidad',
  name: 'Alianza Unidad',
  shortName: 'UNIDAD',
  color: '#0066CC', // Azul representativo
  foundation: '2020',
  ideology: 'Centro-derecha, desarrollo económico, unidad nacional',
  ...
  allies: [
    {
      id: 'alianza-desarrollo-economico',
      name: 'Alianza para el Desarrollo Económico',
      description: 'Coalición de organizaciones empresariales y sociales que respaldan a Alianza Unidad.',
      image: '/Fondos/Organizaciones/AlianzaDesarrolloEconomico.png',
      members: [
        {
          name: 'Cámara de Comercio Nacional',
          role: 'Organización miembro',
          image: '/Fondos/Organizaciones/CamaraComercio.png'
        }
      ]
    }
  ],
  mediaContent: {
    videos: [
      {
        title: 'Presentación de Alianza Unidad',
        url: '/videos/alianza-unidad-presentacion.mp4',
        thumbnail: '/images/thumbnails/alianza-unidad-video1.jpg',
        duration: 180
      }
    ],
    audio: [
      {
        title: 'Entrevista a Samuel Doria Medina',
        url: '/audio/alianza-unidad-entrevista-samuel.mp3',
        duration: 290
      }
    ],
    documents: [
      {
        ...
        url: '/documents/alianza-unidad-programa-gobierno.pdf',
        pages: 38
      }
    ]
  }
