export const apbsumate = {
  id: 'apbsumate',
  name: 'AUTONOMÍA PARA BOLIVIA SÚMATE',
  shortName: 'APBSUMATE',
  color: '#FF4500', // Color representativo (naranja)
  foundation: '2025',
  ideology: 'Autonomía regional, descentralización, desarrollo territorial',
  ...
  allies: [
    {
      id: 'alianza-autonomica',
      name: 'Alianza Autonómica',
      description: 'Coalición de organizaciones regionales que respaldan la autonomía territorial.',
      image: '/Fondos/Organizaciones/AlianzaAutonomica.png',
      members: [
        {
          name: 'Fundación Desarrollo Regional',
          role: 'Organización miembro',
          image: '/Fondos/Organizaciones/FundacionDesarrollo.png'
        }
      ]
    }
  ],
  mediaContent: {
    videos: [
      {
        title: 'Presentación de APBSUMATE',
        url: '/videos/apbsumate-presentacion.mp4',
        thumbnail: '/images/thumbnails/apbsumate-video1.jpg',
        duration: 180
      }
    ],
    audio: [
      {
        title: 'Entrevista a Manfred Reyes Villa',
        url: '/audio/apbsumate-entrevista-manfred.mp3',
        duration: 290
      }
    ],
    documents: [
      {
        ...
        url: '/documents/apbsumate-programa-gobierno.pdf',
        pages: 38
      }
    ]
  }
