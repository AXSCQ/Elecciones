export const ngp = {
  ...
  foundation: '2020',
  ideology: 'Renovación política, transparencia, desarrollo nacional',
  ...
  allies: [
    {
      id: 'alianza-patriotica',
      name: 'Alianza Patriótica Nacional',
      description: 'Coalición de organizaciones y movimientos que respaldan la renovación política.',
      image: '/Fondos/Organizaciones/AlianzaPatriotica.png',
      members: [
        {
          name: 'Fundación Desarrollo Nacional',
  ...
  mediaContent: {
    videos: [
      {
        title: 'Presentación de Nueva Generación Patriótica',
        url: '/videos/ngp-presentacion.mp4',
        thumbnail: '/images/thumbnails/ngp-video1.jpg',
        duration: 180
      }
    ],
    audio: [
      {
        title: 'Entrevista a Fidel Tapia Zambrana',
        url: '/audio/ngp-entrevista-fidel.mp3',
        duration: 290
      }
    ],
    documents: [
      {
        ...
        url: '/documents/ngp-programa-gobierno.pdf',
        pages: 38
      }
    ]
  }
