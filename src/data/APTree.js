export const alianzapopular = {
  id: 'alianzapopular',
  name: 'Alianza Popular',
  shortName: 'AP',
  color: '#FF6B35', // Naranja representativo
  foundation: '2020',
  ideology: 'Democracia participativa, justicia social, desarrollo territorial',
  officialColors: 'Naranja y blanco',
  historicalLeaders: [
    {
  ...
  allies: [
    {
      id: 'alianza-popular-coalicion',
      name: 'Coalición Alianza Popular',
      description: 'Coalición de organizaciones sociales, sindicales y movimientos populares que respaldan a Alianza Popular.',
      image: '/Fondos/Organizaciones/AlianzaPopularCoalicion.png',
      members: [
        {
          name: 'Confederación Sindical de Trabajadores',
          role: 'Organización miembro',
          image: '/Fondos/Organizaciones/ConfederacionSindical.png'
        }
      ]
    }
  ],
  mediaContent: {
    videos: [
      {
        title: 'Presentación de Alianza Popular',
        url: '/videos/alianza-popular-presentacion.mp4',
        thumbnail: '/images/thumbnails/alianza-popular-video1.jpg',
        duration: 180
      }
    ],
    audio: [
      {
        title: 'Entrevista a Andronico Rodriguez',
        url: '/audio/alianza-popular-entrevista-andronico.mp3',
        duration: 290
      }
    ],
    documents: [
      {
        ...
        url: '/documents/alianza-popular-programa-gobierno.pdf',
        pages: 38
      }
    ]
  }
