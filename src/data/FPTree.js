export const fuerzapueblo = {
  id: 'fuerzapueblo',
  name: 'Alianza Fuerza del Pueblo',
  shortName: 'FP',
  color: '#FF6B35', // Naranja representativo
  foundation: '2020',
  ideology: 'Democracia participativa, desarrollo social, justicia',
  officialColors: 'Naranja y azul',
  historicalLeaders: [
    {
  ...
  allies: [
    {
      id: 'alianza-ciudadana-libre',
      name: 'Alianza Ciudadana Libre',
      description: 'Coalición de organizaciones y movimientos sociales que respaldan a Fuerza del Pueblo.',
      image: '/Fondos/Organizaciones/AlianzaCiudadanaLibre.png',
      members: [
        {
          name: 'Fundación Participación Activa',
          role: 'Organización miembro',
          image: '/Fondos/Organizaciones/FundacionParticipacion.png'
        }
      ]
    }
  ],
  mediaContent: {
    videos: [
      {
        title: 'Presentación de Fuerza del Pueblo',
        url: '/videos/fuerzapueblo-presentacion.mp4',
        thumbnail: '/images/thumbnails/fuerzapueblo-video1.jpg',
        duration: 180
      }
    ],
    audio: [
      {
        title: 'Entrevista a Max Jhonny Fernandez Saucedo',
        url: '/audio/fuerzapueblo-entrevista-max.mp3',
        duration: 290
      }
    ],
    documents: [
      {
        ...
        url: '/documents/fuerzapueblo-programa-gobierno.pdf',
        pages: 38
      }
    ]
  }
